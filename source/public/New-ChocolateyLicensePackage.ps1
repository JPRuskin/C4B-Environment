function New-ChocolateyLicensePackage {
    <#
        .Synopsis
    ...
    param(
        ...
        [string]$PackagesPath = "$env:SystemDrive\choco-setup\packages",

        # Path to the license file.
        [string]$LicensePath = "$env:ChocolateyInstall\license\chocolatey.license.xml",

        # The package ID of the generated license package.
        [string]$LicensePackageId = "chocolatey-license",
    ...
    $null = New-Item $PackagingFolder -ItemType Directory -Force
    $null = New-Item $PackagesPath -ItemType Directory -Force

    # Create a new package
    Write-Verbose "Creating package named  '$LicensePackageId'"
    $null = New-Item $licensePackageFolder -ItemType Directory -Force
    $null = New-Item "$licensePackageFolder\tools" -ItemType Directory -Force
